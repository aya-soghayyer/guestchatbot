  ...
  return (
    ...
    <span />
      ...
      <div className="flex h-fit w-fit items-center justify-center space-x-1 rounded-lg rounded-bl-none p-5">
        ...
        <div className="h-2 w-2 animate-bounce rounded-full bg-dark-green [animation-delay:-0.3s]" />
        <div className="h-2 w-2 animate-bounce rounded-full bg-dark-green [animation-delay:-0.15s]" />
        <div className="h-2 w-2 animate-bounce rounded-full bg-dark-green" />
      </div>
